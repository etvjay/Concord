...
# Concord keeps FCC machine evidence at the verifier boundary. This hook
# intentionally does not grant an EOA or TEE machine authority over facility
# balances; the verifier must validate the result before markAllocationVerified.
log "No post-registration authority wiring required for Concord."
