...
# Concord's facility contracts are deployed explicitly by
# scripts/deploy-coston2.sh. Provider funding and treasury actions happen after
# the Makkari/CoFill result is verified, so this hook intentionally does not
# mutate economic state.
log "No pre-TEE economic setup required for Concord."
